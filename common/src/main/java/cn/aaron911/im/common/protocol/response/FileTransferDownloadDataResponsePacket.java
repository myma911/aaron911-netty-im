...
import static cn.aaron911.im.common.protocol.command.Command.FILE_TRANSFER_DOWNLOAD_DATA_RESPONSE;

@Data
@NoArgsConstructor
@AllArgsConstructor
public class FileTransferDownloadDataResponsePacket extends ImPacket {
