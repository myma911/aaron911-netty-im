...
import static cn.aaron911.netty.im.protocol.command.Command.FILE_TRANSFER_DOWNLOAD_DATA_REQUEST;

@Data
@NoArgsConstructor
@AllArgsConstructor
public class FileTransferDownloadDataRequestPacket extends Packet {
